        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                <div class="col-lg-5 col-md-6 mb-4 order-0">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                              <h5 class="text-end"><?php echo "Rp. ". number_format($usulan->sisa, 0,",","."); ?></h5>
                          </div>
                        </div>
                        <hr class="mt-0 mb-3">
                    </div>
